...
using Net40.FxResources.System.Net.Sockets;
...
internal static class SR
{
    ...
    internal static string net_protocol_invalid_multicast_family =>
        GetResourceString("net_protocol_invalid_multicast_family");
    ...
    internal static string net_sockets_invalid_ipaddress_length =>
        GetResourceString("net_sockets_invalid_ipaddress_length");
    ...
    internal static string net_sockets_invalid_optionValue_all =>
        GetResourceString("net_sockets_invalid_optionValue_all");
    ...
    internal static string net_sockets_duplicateandclose_notsupported =>
        GetResourceString("net_sockets_duplicateandclose_notsupported");

    internal static string ArgumentOutOfRange_PathLengthInvalid =>
        GetResourceString("ArgumentOutOfRange_PathLengthInvalid");
    ...
    internal static string InvalidOperation_BufferNotExplicitArray =>
        GetResourceString("InvalidOperation_BufferNotExplicitArray");
    ...
    internal static string InvalidOperation_MultipleContinuations =>
        GetResourceString("InvalidOperation_MultipleContinuations");

    internal static string net_sockets_sendpackelement_FileStreamMustBeAsync =>
        GetResourceString("net_sockets_sendpackelement_FileStreamMustBeAsync");

...
public readonly struct JsonElement
{
	...
	public struct ArrayEnumerator : IEnumerable<JsonElement>, IEnumerable, IEnumerator<JsonElement>, IDisposable, IEnumerator
	{
		...
		public JsonElement Current => (_curIdx < 0) ? default(JsonElement) : new JsonElement(_target._parent, _curIdx);
	...
	public struct ObjectEnumerator : IEnumerable<JsonProperty>, IEnumerable, IEnumerator<JsonProperty>, IDisposable, IEnumerator
	{
		...
		public JsonProperty Current => (_curIdx < 0) ? default(JsonProperty) : new JsonProperty(new JsonElement(_target._parent, _curIdx));
	...
	public bool GetBoolean()
	{
		...
		return type switch
		{
			...
			_ => throw ThrowHelper.GetJsonElementWrongTypeException("Boolean", type), 
		};
	}
	...
	public override string ToString()
	{
		...
		case JsonTokenType.String:
			return GetString();
		default:
			Debug.Fail(string.Format("No handler for {0}.{1}", "JsonTokenType", TokenType));
			return string.Empty;
		}
	}

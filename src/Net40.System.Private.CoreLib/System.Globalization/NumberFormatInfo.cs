...
public sealed class NumberFormatInfo : IFormatProvider, ICloneable
{
    ...
    {
        get { return _currencyDecimalSeparator; }
        set
        {
            VerifyWritable();
    ...
    {
        get { return (int[])_currencyGroupSizes.Clone(); }
        set
        {
            if (value == null)
            {
    ...
    {
        get { return (int[])_numberGroupSizes.Clone(); }
        set
        {
            if (value == null)
            {
    ...
    {
        get { return (int[])_percentGroupSizes.Clone(); }
        set
        {
            if (value == null)
            {
    ...
    {
        get { return _currencyGroupSeparator; }
        set
        {
            VerifyWritable();
    ...
    {
        get { return _currencyNegativePattern; }
        set
        {
            if (value < 0 || value > 15)
            {
    ...
    {
        get { return _numberNegativePattern; }
        set
        {
            if (value < 0 || value > 4)
            {
    ...
    {
        get { return _percentPositivePattern; }
        set
        {
            if (value < 0 || value > 3)
            {
    ...
    {
        get { return _percentNegativePattern; }
        set
        {
            if (value < 0 || value > 11)
            {
    ...
    {
        get { return _negativeInfinitySymbol; }
        set
        {
            if (value == null)
            {
    ...
    {
        get { return _currencyPositivePattern; }
        set
        {
            if (value < 0 || value > 3)
            {
    ...
    {
        get { return _positiveInfinitySymbol; }
        set
        {
            if (value == null)
            {
    ...
    {
        get { return _percentDecimalSeparator; }
        set
        {
            VerifyWritable();
            VerifyDecimalSeparator(value, "value");
    ...
    {
        get { return _percentGroupSeparator; }
        set
        {
            VerifyWritable();
            VerifyGroupSeparator(value, "value");
    ...
    {
        get { return (string[])_nativeDigits.Clone(); }
        set
        {
            VerifyWritable();
    ...
    {
        get { return (DigitShapes)_digitSubstitution; }
        set
        {
            VerifyWritable();
    ...
    public static NumberFormatInfo GetInstance(IFormatProvider? formatProvider)
    {
        ...
        static NumberFormatInfo GetProviderNonNull(IFormatProvider provider)
        {
            ...
            return (provider as NumberFormatInfo) ??
                   (provider.GetFormat(typeof(NumberFormatInfo)) as NumberFormatInfo) ?? CurrentInfo;
        }
    }

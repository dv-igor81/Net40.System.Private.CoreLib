...
public sealed class DateTimeFormatInfo : IFormatProvider, ICloneable
{
	...
	internal string DecimalSeparator
	{
		get
		{
			...
			{
				CultureData cultureData = (_cultureData.UseUserOverride ? CultureData.GetCultureData(_cultureData.CultureName, useUserOverride: false) : _cultureData);
				_decimalSeparator = new NumberFormatInfo(cultureData).NumberDecimalSeparator;
			}
	...
	internal CompareInfo CompareInfo
	{
		get
		{
			...
			{
				_compareInfo = System.Globalization.CompareInfo.GetCompareInfo(_cultureData.SortName);
			}
			return _compareInfo;
		}
	}

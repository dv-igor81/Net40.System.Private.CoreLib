...
public class GregorianCalendar : Calendar
{
        ...
        set
        {
            ...
            if (value < GregorianCalendarTypes.Localized || value > GregorianCalendarTypes.TransliteratedFrench)
            {
                throw new ArgumentOutOfRangeException("value", value,
                    SR.Format("SR.ArgumentOutOfRange_Range", GregorianCalendarTypes.Localized,
    ...
    public override DateTime AddMonths(DateTime time, int months)
    {
        ...
        {
            throw new ArgumentOutOfRangeException("months", months,
    ...
    internal override bool TryToDateTime(int year, int month, int day, int hour, int minute, int second,
        int millisecond, int era, out DateTime result)
    {
        if (era != 0 && era != 1)
        {

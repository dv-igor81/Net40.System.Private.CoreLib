...
using TimeSpanParse = System.Globalization.Net40.TimeSpanParse;
    ...
    ISpanFormattable
{
    ...
    public static TimeSpan ParseExact(ReadOnlySpan<char> input, ReadOnlySpan<char> format,
    ...
    public static TimeSpan ParseExact(ReadOnlySpan<char> input, string[] formats, IFormatProvider? formatProvider,

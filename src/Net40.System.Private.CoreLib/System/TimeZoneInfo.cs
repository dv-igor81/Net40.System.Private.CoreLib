...
using DateTime = System.Net40.DateTime;
...
public sealed class TimeZoneInfo : IEquatable<TimeZoneInfo>, ISerializable, IDeserializationCallback
{
        ...
        private TimeZoneInfo CreateLocal()
        {
            lock (this)
            {
                ...
                if (timeZoneInfo == null)
                {
                    ...
                    timeZoneInfo = (_localTimeZone = new TimeZoneInfo(timeZoneInfo._id, timeZoneInfo._baseUtcOffset,
                        timeZoneInfo._displayName, timeZoneInfo._standardDisplayName, timeZoneInfo._daylightDisplayName,
                        timeZoneInfo._adjustmentRules, disableDaylightSavingTime: false));
                }
    ...
    public sealed class AdjustmentRule : IEquatable<AdjustmentRule>, ISerializable, IDeserializationCallback
    {
        ...
        private readonly Net40.DateTime _dateStart;

        private readonly Net40.DateTime _dateEnd;
        ...
        public Net40.DateTime DateStart => _dateStart;

        public Net40.DateTime DateEnd => _dateEnd;
        ...
        internal bool HasDaylightSaving
        {
            get
            {
                if (!(DaylightDelta != TimeSpan.Zero) && (!(DaylightTransitionStart != default(TransitionTime)) ||
                                                          !(DaylightTransitionStart.TimeOfDay != Net40.DateTime.MinValue)))
                {
                    if (DaylightTransitionEnd != default(TransitionTime))
                    {
                        return DaylightTransitionEnd.TimeOfDay != Net40.DateTime.MinValue.AddMilliseconds(1.0);
                    }
        ...
        {
            if (other != null && _dateStart == other._dateStart && _dateEnd == other._dateEnd &&
                _daylightDelta == other._daylightDelta && _baseUtcOffsetDelta == other._baseUtcOffsetDelta &&
        ...
        private AdjustmentRule(Net40.DateTime dateStart, Net40.DateTime dateEnd, TimeSpan daylightDelta,
        ...
        public static AdjustmentRule CreateAdjustmentRule(Net40.DateTime dateStart, Net40.DateTime dateEnd, TimeSpan daylightDelta,
            TransitionTime daylightTransitionStart, TransitionTime daylightTransitionEnd)
        {
            return new AdjustmentRule(dateStart, dateEnd, daylightDelta, daylightTransitionStart, daylightTransitionEnd,
                TimeSpan.Zero, noDaylightTransitions: false);
        }

        internal static AdjustmentRule CreateAdjustmentRule(Net40.DateTime dateStart, Net40.DateTime dateEnd,
            TimeSpan daylightDelta, TransitionTime daylightTransitionStart, TransitionTime daylightTransitionEnd,
            TimeSpan baseUtcOffsetDelta, bool noDaylightTransitions)
        {
        ...
        internal bool IsStartDateMarkerForBeginningOfYear()
        {
            if (!NoDaylightTransitions && DaylightTransitionStart.Month == 1 && DaylightTransitionStart.Day == 1 &&
                DaylightTransitionStart.TimeOfDay.Hour == 0 && DaylightTransitionStart.TimeOfDay.Minute == 0 &&
                DaylightTransitionStart.TimeOfDay.Second == 0)
            {
        ...
        internal bool IsEndDateMarkerForEndOfYear()
        {
            if (!NoDaylightTransitions && DaylightTransitionEnd.Month == 1 && DaylightTransitionEnd.Day == 1 &&
                DaylightTransitionEnd.TimeOfDay.Hour == 0 && DaylightTransitionEnd.TimeOfDay.Minute == 0 &&
                DaylightTransitionEnd.TimeOfDay.Second == 0)
            {
                return _dateStart.Year == _dateEnd.Year;
            }
        ...
        private static void ValidateAdjustmentRule(Net40.DateTime dateStart, Net40.DateTime dateEnd, TimeSpan daylightDelta,
            TransitionTime daylightTransitionStart, TransitionTime daylightTransitionEnd, bool noDaylightTransitions)
        {
            ...
            if (dateStart != Net40.DateTime.MinValue && dateStart.Kind == DateTimeKind.Unspecified &&
                dateStart.TimeOfDay != TimeSpan.Zero)
            {
                throw new ArgumentException("SR.Argument_DateTimeHasTimeOfDay", "dateStart");
            }

            if (dateEnd != Net40.DateTime.MaxValue && dateEnd.Kind == DateTimeKind.Unspecified &&
        ...
        private static void AdjustDaylightDeltaToExpectedRange(ref TimeSpan daylightDelta,
        ...
        void IDeserializationCallback.OnDeserialization(object sender)
        {
            try
            {
                ValidateAdjustmentRule(_dateStart, _dateEnd, _daylightDelta, _daylightTransitionStart,
                    _daylightTransitionEnd, _noDaylightTransitions);
            }
    ...
    private struct StringSerializer
    {
        ...
        /*public static string GetSerializedString(TimeZoneInfo zone)
        {
            ...
            stringBuilder.AppendSpanFormattable(zone.BaseUtcOffset.TotalMinutes, null, CultureInfo.InvariantCulture);
            stringBuilder.Append(';');
            ...
            {
                stringBuilder.Append('[');
                stringBuilder.AppendSpanFormattable(adjustmentRule.DateStart, "MM:dd:yyyy",
                    DateTimeFormatInfo.InvariantInfo);
                stringBuilder.Append(';');
                stringBuilder.AppendSpanFormattable(adjustmentRule.DateEnd, "MM:dd:yyyy",
                    DateTimeFormatInfo.InvariantInfo);
                stringBuilder.Append(';');
                stringBuilder.AppendSpanFormattable(adjustmentRule.DaylightDelta.TotalMinutes, null,
                ...
                {
                    stringBuilder.AppendSpanFormattable(adjustmentRule.BaseUtcOffsetDelta.TotalMinutes, null,
                        CultureInfo.InvariantCulture);
                    stringBuilder.Append(';');
                }
        ...
        public static TimeZoneInfo GetDeserializedTimeZoneInfo(string source)
        {
            ...
            try
            {
                return new TimeZoneInfo(nextStringValue, nextTimeSpanValue, nextStringValue2, nextStringValue3,
                    nextStringValue4, nextAdjustmentRuleArrayValue, disableDaylightSavingTime: false);
            }
            catch (ArgumentException innerException)
            {
                throw new SerializationException("SR.Serialization_InvalidData", innerException);
        ...
        private Net40.DateTime GetNextDateTimeValue(string format)
        {
            string nextStringValue = GetNextStringValue();
            if (!Net40.DateTime.TryParseExact(nextStringValue, format, DateTimeFormatInfo.InvariantInfo, DateTimeStyles.None,
                    out var result))
            {
                throw new SerializationException("SR.Serialization_InvalidData");
            }
        ...
        private AdjustmentRule[] GetNextAdjustmentRuleArrayValue()
        {
            ...
            int num = 0;
            for (AdjustmentRule nextAdjustmentRuleValue = GetNextAdjustmentRuleValue();
                 nextAdjustmentRuleValue != null;
                 nextAdjustmentRuleValue = GetNextAdjustmentRuleValue())
            {
        ...
        private AdjustmentRule GetNextAdjustmentRuleValue()
        {
            ...
            Net40.DateTime nextDateTimeValue = GetNextDateTimeValue("MM:dd:yyyy");
            Net40.DateTime nextDateTimeValue2 = GetNextDateTimeValue("MM:dd:yyyy");
            ...
            try
            {
                result = AdjustmentRule.CreateAdjustmentRule(nextDateTimeValue, nextDateTimeValue2, nextTimeSpanValue,
                    nextTransitionTimeValue, nextTransitionTimeValue2, baseUtcOffsetDelta, num > 0);
            }
            catch (ArgumentException innerException)
            {
                throw new SerializationException("SR.Serialization_InvalidData", innerException);
        ...
        private TransitionTime GetNextTransitionTimeValue()
        {
            ...
            Net40.DateTime nextDateTimeValue = GetNextDateTimeValue("HH:mm:ss.FFF");
            nextDateTimeValue = new Net40.DateTime(1, 1, 1, nextDateTimeValue.Hour, nextDateTimeValue.Minute,
                nextDateTimeValue.Second, nextDateTimeValue.Millisecond);
            ...
            else
            {
                ...
                try
                {
                    result = TransitionTime.CreateFloatingDateRule(nextDateTimeValue, nextInt32Value2, nextInt32Value4,
    ...
    {
        private readonly Net40.DateTime _timeOfDay;
        ...
        public Net40.DateTime TimeOfDay => _timeOfDay;
        ...
        private TransitionTime(Net40.DateTime timeOfDay, int month, int week, int day, DayOfWeek dayOfWeek,
        ...
        public static TransitionTime CreateFixedDateRule(Net40.DateTime timeOfDay, int month, int day)
        {
            return new TransitionTime(timeOfDay, month, 1, day, DayOfWeek.Sunday, isFixedDateRule: true);
        }

        public static TransitionTime CreateFloatingDateRule(Net40.DateTime timeOfDay, int month, int week,
            DayOfWeek dayOfWeek)
        {
            return new TransitionTime(timeOfDay, month, week, 1, dayOfWeek, isFixedDateRule: false);
        }

        private static void ValidateTransitionTime(Net40.DateTime timeOfDay, int month, int week, int day,
            DayOfWeek dayOfWeek)
        {
            if (timeOfDay.Kind != 0)
            {
        ...
        private TransitionTime(SerializationInfo info, StreamingContext context)
        {
            ...
            _timeOfDay = (Net40.DateTime)info.GetValue("TimeOfDay", typeof(Net40.DateTime));
    ...
    private static readonly TimeZoneInfo s_utcTimeZone = CreateCustomTimeZone("UTC", TimeSpan.Zero,
        "(UTC) Coordinated Universal Time", "Coordinated Universal Time");

    private static CachedData s_cachedData = new CachedData();

    private static readonly Net40.DateTime s_maxDateOnly = new Net40.DateTime(9999, 12, 31);

    private static readonly Net40.DateTime s_minDateOnly = new Net40.DateTime(1, 1, 2);
    ...
    public TimeSpan[] GetAmbiguousTimeOffsets(DateTimeOffset dateTimeOffset)
    {
        ...
        Net40.DateTime dateTime = ConvertTime(dateTimeOffset, this).DateTime;
        bool flag = false;
        int? ruleIndex;
        AdjustmentRule adjustmentRuleForAmbiguousOffsets =
            GetAdjustmentRuleForAmbiguousOffsets(dateTime, out ruleIndex);
        if (adjustmentRuleForAmbiguousOffsets != null && adjustmentRuleForAmbiguousOffsets.HasDaylightSaving)
        {
            DaylightTimeStruct daylightTime =
                GetDaylightTime(dateTime.Year, adjustmentRuleForAmbiguousOffsets, ruleIndex);
    ...
    public TimeSpan[] GetAmbiguousTimeOffsets(DateTime dateTime)
    {
        ...
        int? ruleIndex;
        AdjustmentRule adjustmentRuleForAmbiguousOffsets =
            GetAdjustmentRuleForAmbiguousOffsets(dateTime2, out ruleIndex);
        if (adjustmentRuleForAmbiguousOffsets != null && adjustmentRuleForAmbiguousOffsets.HasDaylightSaving)
        {
            DaylightTimeStruct daylightTime =
                GetDaylightTime(dateTime2.Year, adjustmentRuleForAmbiguousOffsets, ruleIndex);
    ...
    private AdjustmentRule GetAdjustmentRuleForAmbiguousOffsets(DateTime adjustedTime, out int? ruleIndex)
    {
        ...
        if (adjustmentRuleForTime != null && adjustmentRuleForTime.NoDaylightTransitions &&
            !adjustmentRuleForTime.HasDaylightSaving)
        {
    ...
    internal bool IsAmbiguousTime(DateTime dateTime, TimeZoneInfoOptions flags)
    {
        ...
        CachedData cachedData = s_cachedData;
        DateTime dateTime2 = ((dateTime.Kind == DateTimeKind.Local)
    ...
    public bool IsInvalidTime(DateTime dateTime)
    {
        ...
        if (dateTime.Kind == DateTimeKind.Unspecified || (dateTime.Kind == DateTimeKind.Local &&
                                                          s_cachedData.GetCorrespondingKind(this) ==
                                                          DateTimeKind.Local))
        {
            int? ruleIndex;
    ...
    public static DateTimeOffset ConvertTimeBySystemTimeZoneId(DateTimeOffset dateTimeOffset,
    ...
    public static DateTime ConvertTimeBySystemTimeZoneId(DateTime dateTime, string sourceTimeZoneId,
        string destinationTimeZoneId)
    {
        if (dateTime.Kind == DateTimeKind.Local &&
        ...
        {
            CachedData cachedData = s_cachedData;
            return ConvertTime(dateTime, cachedData.Local, FindSystemTimeZoneById(destinationTimeZoneId),
                TimeZoneInfoOptions.None, cachedData);
        }

        if (dateTime.Kind == DateTimeKind.Utc &&
            string.Equals(sourceTimeZoneId, Utc.Id, StringComparison.OrdinalIgnoreCase))
        {
            return ConvertTime(dateTime, s_utcTimeZone, FindSystemTimeZoneById(destinationTimeZoneId),
                TimeZoneInfoOptions.None, s_cachedData);
        }

        return ConvertTime(dateTime, FindSystemTimeZoneById(sourceTimeZoneId),
    ...
    public static DateTimeOffset ConvertTime(DateTimeOffset dateTimeOffset, TimeZoneInfo destinationTimeZone)
    {
        ...
        Net40.DateTime utcDateTime = dateTimeOffset.UtcDateTime;
    ...
    internal static DateTime ConvertTime(DateTime dateTime, TimeZoneInfo sourceTimeZone,
        TimeZoneInfo destinationTimeZone, TimeZoneInfoOptions flags)
    {
    ...
    private static DateTime ConvertTime(DateTime dateTime, TimeZoneInfo sourceTimeZone,
        TimeZoneInfo destinationTimeZone, TimeZoneInfoOptions flags, CachedData cachedData)
    {
        ...
        if ((flags & TimeZoneInfoOptions.NoThrowOnInvalidTime) == 0 && dateTime.Kind != 0 &&
            dateTime.Kind != correspondingKind)
        {
        ...
        if (adjustmentRuleForTime != null)
        {
            ...
            if (adjustmentRuleForTime.HasDaylightSaving)
            {
                bool flag = false;
                DaylightTimeStruct daylightTime =
                    sourceTimeZone.GetDaylightTime(dateTime.Year, adjustmentRuleForTime, ruleIndex);
                if ((flags & TimeZoneInfoOptions.NoThrowOnInvalidTime) == 0 &&
                    GetIsInvalidTime(dateTime, adjustmentRuleForTime, daylightTime))
                {
    ...
    public static ReadOnlyCollection<TimeZoneInfo> GetSystemTimeZones()
    {
        ...
        lock (cachedData)
        {
            if (cachedData._readOnlySystemTimeZones == null)
            {
                ...
                List<TimeZoneInfo> list = ((cachedData._systemTimeZones == null)
                    ? new List<TimeZoneInfo>()
                    : new List<TimeZoneInfo>(cachedData._systemTimeZones.Values));
    ...
    public bool HasSameRules(TimeZoneInfo other)
    {
        ...
        bool flag = (adjustmentRules == null && adjustmentRules2 == null) ||
                    (adjustmentRules != null && adjustmentRules2 != null);
        if (!flag)
        {
            return false;
        }
    ...
    private TimeZoneInfo(string id, TimeSpan baseUtcOffset, string displayName, string standardDisplayName,
        string daylightDisplayName, AdjustmentRule[] adjustmentRules, bool disableDaylightSavingTime)
    {
    ...
    public static TimeZoneInfo CreateCustomTimeZone(string id, TimeSpan baseUtcOffset, string? displayName,
        string? standardDisplayName)
    {
        return new TimeZoneInfo(id, baseUtcOffset, displayName, standardDisplayName, standardDisplayName, null,
            disableDaylightSavingTime: false);
    }

    public static TimeZoneInfo CreateCustomTimeZone(string id, TimeSpan baseUtcOffset, string? displayName,
        string? standardDisplayName, string? daylightDisplayName, AdjustmentRule[]? adjustmentRules)
    {
        return CreateCustomTimeZone(id, baseUtcOffset, displayName, standardDisplayName, daylightDisplayName,
            adjustmentRules, disableDaylightSavingTime: false);
    }
        ...
        bool disableDaylightSavingTime)
    {
        ...
        return new TimeZoneInfo(id, baseUtcOffset, displayName, standardDisplayName, daylightDisplayName,
    ...
    void IDeserializationCallback.OnDeserialization(object sender)
    {
        try
        {
            ...
            {
                throw new SerializationException(SR.Format(SR.Serialization_CorruptField,
    ...
    private int CompareAdjustmentRuleToDateTime(AdjustmentRule rule, AdjustmentRule previousRule, DateTime dateTime,
        DateTime dateOnly, bool dateTimeisUtc)
    {
        bool flag;
        if (rule.DateStart.Kind == DateTimeKind.Utc)
        {
            DateTime dateTime2 = (dateTimeisUtc
                ? dateTime
        ...
        {
            DateTime dateTime3 = (dateTimeisUtc
                ? dateTime
    ...
    {
        DateTime time = ((ticks > DateTime.MaxValue.Ticks)
            ? DateTime.MaxValue
    ...
    private DaylightTimeStruct GetDaylightTime(int year, AdjustmentRule rule, int? ruleIndex)
    {
        ...
        if (rule.NoDaylightTransitions)
        {
            ...
            start = ConvertFromUtc(rule.DateStart, previousAdjustmentRule.DaylightDelta,
                previousAdjustmentRule.BaseUtcOffsetDelta);
        ...
        TimeZoneInfoOptions flags)
    {
        ...
        if (time.Kind == DateTimeKind.Local)
        {
            ...
            endTime = (rule.IsEndDateMarkerForEndOfYear()
                ? new DateTime(daylightTime.End.Year + 1, 1, 1, 0, 0, 0).AddTicks(-1L)
                : daylightTime.End);
        }
        else
        {
            ...
            startTime = (rule.IsStartDateMarkerForBeginningOfYear()
                ? new DateTime(daylightTime.Start.Year, 1, 1, 0, 0, 0)
                : (daylightTime.Start + (flag ? rule.DaylightDelta : TimeSpan.Zero)));
            endTime = (rule.IsEndDateMarkerForEndOfYear()
                ? new DateTime(daylightTime.End.Year + 1, 1, 1, 0, 0, 0).AddTicks(-1L)
                : (daylightTime.End + (flag ? (-rule.DaylightDelta) : TimeSpan.Zero)));
        }
    ...
    private static bool GetIsDaylightSavingsFromUtc(DateTime time, int year, TimeSpan utc, AdjustmentRule rule,
        int? ruleIndex, out bool isAmbiguousLocalDst, TimeZoneInfo zone)
    {
        ...
        if (rule.IsStartDateMarkerForBeginningOfYear() && daylightTime.Start.Year > DateTime.MinValue.Year)
        {
            ...
            AdjustmentRule adjustmentRuleForTime =
                zone.GetAdjustmentRuleForTime(new DateTime(daylightTime.Start.Year - 1, 12, 31), out ruleIndex2);
            if (adjustmentRuleForTime != null && adjustmentRuleForTime.IsEndDateMarkerForEndOfYear())
            {
                dateTime = zone.GetDaylightTime(daylightTime.Start.Year - 1, adjustmentRuleForTime, ruleIndex2).Start -
                           utc - adjustmentRuleForTime.BaseUtcOffsetDelta;
        ...
        {
            int? ruleIndex3;
            AdjustmentRule adjustmentRuleForTime2 =
                zone.GetAdjustmentRuleForTime(new DateTime(daylightTime.End.Year + 1, 1, 1), out ruleIndex3);
            if (adjustmentRuleForTime2 != null && adjustmentRuleForTime2.IsStartDateMarkerForBeginningOfYear())
            {
                dateTime2 = ((!adjustmentRuleForTime2.IsEndDateMarkerForEndOfYear())
                    ? (zone.GetDaylightTime(daylightTime.End.Year + 1, adjustmentRuleForTime2, ruleIndex3).End - utc -
                       adjustmentRuleForTime2.BaseUtcOffsetDelta - adjustmentRuleForTime2.DaylightDelta)
                    : (new DateTime(daylightTime.End.Year + 1, 12, 31) - utc -
                       adjustmentRuleForTime2.BaseUtcOffsetDelta - adjustmentRuleForTime2.DaylightDelta));
                ignoreYearAdjustment = true;
            }
            else
            {
                dateTime2 = new DateTime(daylightTime.End.Year + 1, 1, 1, 0, 0, 0).AddTicks(-1L) -
                            daylightSavingsEndOffsetFromUtc;
            }
        }
        else
        {
    ...
    internal static TimeSpan GetUtcOffsetFromUtc(DateTime time, TimeZoneInfo zone, out bool isDaylightSavings,
        out bool isAmbiguousLocalDst)
    {
        ...
        if (adjustmentRuleForTime != null)
        {
            ...
            if (adjustmentRuleForTime.HasDaylightSaving)
            {
                isDaylightSavings = GetIsDaylightSavingsFromUtc(time, year, zone._baseUtcOffset, adjustmentRuleForTime,
                    ruleIndex, out isAmbiguousLocalDst, zone);
                baseUtcOffset += (isDaylightSavings ? adjustmentRuleForTime.DaylightDelta : TimeSpan.Zero);
            }
        }
    ...
    internal static DateTime TransitionTimeToDateTime(int year, TransitionTime transitionTime)
    {
        ...
        if (transitionTime.IsFixedDateRule)
        {
            ...
            result = new DateTime(year, transitionTime.Month, (num < transitionTime.Day) ? num : transitionTime.Day,
                timeOfDay.Hour, timeOfDay.Minute, timeOfDay.Second, timeOfDay.Millisecond);
        }
        else if (transitionTime.Week <= 4)
        {
            result = new DateTime(year, transitionTime.Month, 1, timeOfDay.Hour, timeOfDay.Minute, timeOfDay.Second,
        ...
        else
        {
            ...
            result = new DateTime(year, transitionTime.Month, day, timeOfDay.Hour, timeOfDay.Minute, timeOfDay.Second,
                timeOfDay.Millisecond);
    ...
    private static TimeZoneInfoResult TryGetTimeZone(string id, bool dstDisabled, out TimeZoneInfo value,
        out Exception e, CachedData cachedData, bool alwaysFallbackToLocalMachine = false)
    {
        ...
        if (cachedData._systemTimeZones != null && cachedData._systemTimeZones.TryGetValue(id, out value2))
        {
            ...
            {
                value = CreateCustomTimeZone(value2._id, value2._baseUtcOffset, value2._displayName,
                    value2._standardDisplayName);
            }
            else
            {
                value = new TimeZoneInfo(value2._id, value2._baseUtcOffset, value2._displayName,
                    value2._standardDisplayName, value2._daylightDisplayName, value2._adjustmentRules,
                    disableDaylightSavingTime: false);
            }
    ...
    private static TimeZoneInfoResult TryGetTimeZoneFromLocalMachine(string id, bool dstDisabled,
        out TimeZoneInfo value, out Exception e, CachedData cachedData)
    {
        TimeZoneInfo value2;
        ...
        if (timeZoneInfoResult == TimeZoneInfoResult.Success)
        {
            if (cachedData._systemTimeZones == null)
            {
                ...
                cachedData._systemTimeZones.Add("UTC", s_utcTimeZone);
            }
    ...
    private static void ValidateTimeZoneInfo(string id, TimeSpan baseUtcOffset, AdjustmentRule[] adjustmentRules,
    ...
    {
        return baseUtcOffset + adjustmentRule.BaseUtcOffsetDelta +
    ...
    private TimeZoneInfo(in Interop.Kernel32.TIME_ZONE_INFORMATION zone, bool dstDisabled)
    {
        ...
        if (!dstDisabled)
        {
            ...
            AdjustmentRule adjustmentRule = CreateAdjustmentRuleFromTimeZoneInformation(in timeZoneInformation,
                DateTime.MinValue.Date, DateTime.MaxValue.Date, zone.Bias);
    ...
    private static AdjustmentRule CreateAdjustmentRuleFromTimeZoneInformation(
        in Interop.Kernel32.REG_TZI_FORMAT timeZoneInformation, DateTime startDate, DateTime endDate,
        int defaultBaseUtcOffset)
    {
        if (timeZoneInformation.StandardDate.Month == 0)
        {
            ...
            return AdjustmentRule.CreateAdjustmentRule(startDate, endDate, TimeSpan.Zero,
                TransitionTime.CreateFixedDateRule(DateTime.MinValue, 1, 1),
                TransitionTime.CreateFixedDateRule(DateTime.MinValue.AddMilliseconds(1.0), 1, 1),
                new TimeSpan(0, defaultBaseUtcOffset - timeZoneInformation.Bias, 0), noDaylightTransitions: false);
        }
        ...
        if (!TransitionTimeFromTimeZoneInformation(in timeZoneInformation, out var transitionTime2,
                readStartDate: false))
        {
            return null;
        }
        ...
        return AdjustmentRule.CreateAdjustmentRule(startDate, endDate,
            new TimeSpan(0, -timeZoneInformation.DaylightBias, 0), transitionTime, transitionTime2,
            new TimeSpan(0, defaultBaseUtcOffset - timeZoneInformation.Bias, 0), noDaylightTransitions: false);
    }

    private static string FindIdFromTimeZoneInformation(in Interop.Kernel32.TIME_ZONE_INFORMATION timeZone,
    ...
    private static TimeZoneInfo GetLocalTimeZone(CachedData cachedData)
    {
        Interop.Kernel32.TIME_DYNAMIC_ZONE_INFORMATION pTimeZoneInformation =
            default(Interop.Kernel32.TIME_DYNAMIC_ZONE_INFORMATION);
        ...
        if (timeZoneKeyName.Length != 0 &&
            TryGetTimeZone(timeZoneKeyName, pTimeZoneInformation.DynamicDaylightTimeDisabled != 0, out var value,
                out var e, cachedData) == TimeZoneInfoResult.Success)
        {
            return value;
        }

        Interop.Kernel32.TIME_ZONE_INFORMATION timeZone =
            new Interop.Kernel32.TIME_ZONE_INFORMATION(in pTimeZoneInformation);
        bool dstDisabled;
        string text = FindIdFromTimeZoneInformation(in timeZone, out dstDisabled);
        if (text != null && TryGetTimeZone(text, dstDisabled, out var value2, out e, cachedData) ==
    ...
    private static TimeZoneInfo GetLocalTimeZoneFromWin32Data(
        in Interop.Kernel32.TIME_ZONE_INFORMATION timeZoneInformation, bool dstDisabled)
    {
        try
        {
    ...
    public static TimeZoneInfo FindSystemTimeZoneById(string id)
    {
        ...
        return timeZoneInfoResult switch
        {
            ...
            TimeZoneInfoResult.InvalidTimeZoneException => throw new InvalidTimeZoneException(
                SR.Format(SR.InvalidTimeZone_InvalidRegistryData, id), e),
            TimeZoneInfoResult.SecurityException => throw new SecurityException(
                SR.Format(SR.Security_CannotReadRegistryData, id), e),
    ...
    internal static TimeSpan GetDateTimeNowUtcOffsetFromUtc(DateTime time, out bool isAmbiguousLocalDst)
    {
        ...
        if (oneYearLocalFromUtc.Rule != null)
        {
            ...
            {
                flag = GetIsDaylightSavingsFromUtc(time, year, oneYearLocalFromUtc.Offset, oneYearLocalFromUtc.Rule,
                    null, out isAmbiguousLocalDst, Local);
    ...
    private static bool TransitionTimeFromTimeZoneInformation(in Interop.Kernel32.REG_TZI_FORMAT timeZoneInformation,
        out TransitionTime transitionTime, bool readStartDate)
    {
        if (timeZoneInformation.StandardDate.Month == 0)
        {
        ...
        if (readStartDate)
        {
            if (timeZoneInformation.DaylightDate.Year == 0)
            {
                transitionTime = TransitionTime.CreateFloatingDateRule(
                    new DateTime(1, 1, 1, timeZoneInformation.DaylightDate.Hour,
                        timeZoneInformation.DaylightDate.Minute, timeZoneInformation.DaylightDate.Second,
                        timeZoneInformation.DaylightDate.Milliseconds), timeZoneInformation.DaylightDate.Month,
        ...
        {
            transitionTime = TransitionTime.CreateFloatingDateRule(
                new DateTime(1, 1, 1, timeZoneInformation.StandardDate.Hour, timeZoneInformation.StandardDate.Minute,
                    timeZoneInformation.StandardDate.Second, timeZoneInformation.StandardDate.Milliseconds),
                timeZoneInformation.StandardDate.Month, timeZoneInformation.StandardDate.Day,
    ...
    private static bool TryCreateAdjustmentRules(string id,
        in Interop.Kernel32.REG_TZI_FORMAT defaultTimeZoneInformation, out AdjustmentRule[] rules, out Exception e,
        int defaultBaseUtcOffset)
    {
        rules = null;
        e = null;
        try
        {
            using RegistryKey registryKey = Registry.LocalMachine.OpenSubKey(
                "SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Time Zones\\" + id + "\\Dynamic DST",
                writable: false);
            if (registryKey == null)
            {
                AdjustmentRule adjustmentRule = CreateAdjustmentRuleFromTimeZoneInformation(
                    in defaultTimeZoneInformation, DateTime.MinValue.Date, DateTime.MaxValue.Date,
            ...
            if (num == num2)
            {
                AdjustmentRule adjustmentRule2 = CreateAdjustmentRuleFromTimeZoneInformation(in dtzi,
                    DateTime.MinValue.Date, DateTime.MaxValue.Date, defaultBaseUtcOffset);
                if (adjustmentRule2 != null)
                {
            ...
            List<AdjustmentRule> list = new List<AdjustmentRule>(1);
            AdjustmentRule adjustmentRule3 = CreateAdjustmentRuleFromTimeZoneInformation(in dtzi,
                DateTime.MinValue.Date, new DateTime(num, 12, 31), defaultBaseUtcOffset);
            ...
            for (int i = num + 1; i < num2; i++)
            {
                ...
                AdjustmentRule adjustmentRule4 = CreateAdjustmentRuleFromTimeZoneInformation(in dtzi,
                    new DateTime(i, 1, 1), new DateTime(i, 12, 31), defaultBaseUtcOffset);
            ...
            AdjustmentRule adjustmentRule5 = CreateAdjustmentRuleFromTimeZoneInformation(in dtzi,
                new DateTime(num2, 1, 1), DateTime.MaxValue.Date, defaultBaseUtcOffset);
    ...
    private unsafe static bool TryGetTimeZoneEntryFromRegistry(RegistryKey key, string name,
        out Interop.Kernel32.REG_TZI_FORMAT dtzi)
    {
    ...
    private static bool TryCompareStandardDate(in Interop.Kernel32.TIME_ZONE_INFORMATION timeZone,
        in Interop.Kernel32.REG_TZI_FORMAT registryTimeZoneInfo)
    {
    ...
    private static bool TryCompareTimeZoneInformationToRegistry(in Interop.Kernel32.TIME_ZONE_INFORMATION timeZone,
        string id, out bool dstDisabled)
    {
        dstDisabled = false;
        using RegistryKey registryKey =
            Registry.LocalMachine.OpenSubKey("SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Time Zones\\" + id,
                writable: false);
        if (registryKey == null)
        {
            return false;
        ...
        bool flag = dstDisabled || CheckDaylightSavingTimeNotSupported(in timeZone) ||
                    (timeZone.DaylightBias == dtzi.DaylightBias && timeZone.DaylightDate.Equals(in dtzi.DaylightDate));
        if (flag)
        {
    ...
    private unsafe static string TryGetLocalizedNameByMuiNativeResource(string resource)
    {
        ...
        try
        {
            char* ptr = stackalloc char[260];
            int pcchFileMUIPath = 260;
            int pcchLanguage = 0;
            long pululEnumerator = 0L;
            return Interop.Kernel32.GetFileMUIPath(16u, pcwszFilePath, null, ref pcchLanguage, ptr, ref pcchFileMUIPath,
                ref pululEnumerator)
                ? TryGetLocalizedNameByNativeResource(new string(ptr, 0, pcchFileMUIPath), result)
                : string.Empty;
        }
    ...
    private unsafe static string TryGetLocalizedNameByNativeResource(string filePath, int resource)
    {
        using (SafeLibraryHandle safeLibraryHandle = Interop.Kernel32.LoadLibraryEx(filePath, IntPtr.Zero, 2))
        {
            if (!safeLibraryHandle.IsInvalid)
            {
                ...
                int num = Interop.User32.LoadString(safeLibraryHandle, (uint)resource, ptr, 500);
                if (num != 0)
                {
    ...
    private static void GetLocalizedNamesByRegistryKey(RegistryKey key, out string displayName, out string standardName,
    ...
    private static TimeZoneInfoResult TryGetTimeZoneFromLocalMachine(string id, out TimeZoneInfo value, out Exception e)
    {
        ...
        try
        {
            value = new TimeZoneInfo(id, new TimeSpan(0, -dtzi.Bias, 0), displayName, standardName, daylightName, rules,
                disableDaylightSavingTime: false);
